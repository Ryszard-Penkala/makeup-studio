...
dataScrollTrigger.forEach((section) => {
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo(section.children, { y: '+=100', opacity: 0 }, {
    y: 0,
    opacity: 1,
    stagger: 0.2,
    duration: 1,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var macy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
...
const macyInstance = macy__WEBPACK_IMPORTED_MODULE_0___default()({
